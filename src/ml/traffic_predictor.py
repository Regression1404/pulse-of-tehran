...
class TrafficVolumePredictor:
    def __init__(self, dataframe, model=LinearRegression(), target_column="total number of vehicles"):
        self.model = model
        self.features = ["start hour", "day of week", "month", "axis code", "year_from_prediction"]
